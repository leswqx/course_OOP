...
- Total properties in system (активные/проданные)
- Финансовый рейтинг риелторов (график LiveCharts: кто на какую сумму продал объектов)
- Рейтинг эффективности (конверсия из показов в сделки)
- Client rating (средняя оценка по отзывам из БД)
- Revenue statistics
...
- Мой финансовый результат (сумма всех моих проданных объектов)
- Количество успешных сделок
- Личный рейтинг (средняя оценка от клиентов)
