    ...
    private static async Task SeedPropertiesAsync(AppDbContext context)
    {
        ...
        var properties = new List<Property>
        {
            ...
            new()
            {
                ...
                YearBuilt = 2010,
                City = "Подмосковье",
                Address = "п. Зеленоградский, ул. Садовая, д. 7",
                HasRepair = true,
            ...
            new()
            {
                ...
                Description = "Компактная и функциональная студия с качественным ремонтом. " +
                              "Идеально для молодых специалистов или как инвестиция под аренду. " +
                ...
                YearBuilt = 2020,
                City = "Москва",
                Address = "ул. Профсоюзная, д. 88, кв. 312",
                HasRepair = true,
                MortgageAvailable = true,
                Status = "active",
                RealtorId = realtor.Id,
            ...
            new()
            {
                ...
                Address = "пр. Невский, д. 120, кв. 18",
                HasRepair = false,
                MortgageAvailable = true,
                Status = "active",
                RealtorId = realtor.Id,
            ...
            new()
            {
                ...
                YearBuilt = 2023,
                City = "Москва",
                Address = "Пресненская наб., д. 6, кв. 1502",
                HasRepair = true,
                MortgageAvailable = true,
                Status = "active",
                RealtorId = realtor.Id,
