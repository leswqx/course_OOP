...
public interface IAppointmentService
{
    ...
    Task UpdateStatusAsync(int id, AppointmentStatus status, string? comment = null);
...
public interface IFavoriteService
{
    ...
    Task<IEnumerable<Property>> GetUserFavoritesPagedAsync(int userId, int skip, int take);
